    ...
    echo <<<_ARTICLE
        <section class="section">
            <article class="article">
                ...
                <p>
                    Since service operators don't need to reverse passwords, only to verify they are correct, passwords are hashed. Hash algorithms convert plaintext values 
                    into ciphertext in a one-way process.
                </p>
                <p>
                ...
                <p>
                    ...
                    many other techniques to make the job easier may not work.
                </p>
                <p>
                    ...
                    <table class="table">
                        <thead>
                            <tr class="d-flex">
                                ...
                                <th class="col-lg-2 col-md-4 col-sm-4">Lower & Uppercase Letters</th>
                                <th class="col-lg-2 col-md-4 col-sm-4">Complex Passwords</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="d-flex">
                                <td class="col-lg-2 col-md-4 col-sm-4">8 Characters</td>
                                <td class="col-lg-2 col-md-4 col-sm-4">22 minutes</td>
                                <td class="col-lg-2 col-md-4 col-sm-4">8 hours</td>
                            </tr>
                            <tr class="d-flex">
                                <td class="col-lg-2 col-md-4 col-sm-4">9 Characters</td>
                                <td class="col-lg-2 col-md-4 col-sm-4">19 hours</td>
                                <td class="col-lg-2 col-md-4 col-sm-4">3 weeks</td>
                            </tr>
                            <tr class="d-flex">
                                <td class="col-lg-2 col-md-4 col-sm-4">10 Characters</td>
                                <td class="col-lg-2 col-md-4 col-sm-4">1 month</td>
                                <td class="col-lg-2 col-md-4 col-sm-4">5 years</td>
                            </tr>
                            <tr class="d-flex">
                                <td class="col-lg-2 col-md-4 col-sm-4">11 Characters</td>
                                <td class="col-lg-2 col-md-4 col-sm-4">5 years</td>
                                <td class="col-lg-2 col-md-4 col-sm-4">500 years</td>
                            </tr>
                            <tr class="d-flex">
                                <td class="col-lg-2 col-md-4 col-sm-4">12 Characters</td>
                                <td class="col-lg-2 col-md-4 col-sm-4">300 years</td>
                                <td class="col-lg-2 col-md-4 col-sm-4">34k years</td>
                            </tr> 
                        </tbody>
                    </table
                </div>
